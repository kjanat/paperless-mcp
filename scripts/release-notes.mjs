...
const PKG = '@kjanat/paperless-mcp';
...
export function buildNotes(changelog, version) {
	...
	const badge = `[![NPM Version](https://img.shields.io/badge/npm-v${version}-black`
		+ `?logo=npm&labelColor=CB3837)]`
...
export async function updateReleaseNotes({ github, context, core }) {
	...
	const changelog = await readFile(`${process.env['GITHUB_WORKSPACE']}/CHANGELOG.md`, 'utf8');
